    ...
    public partial class InitDataBase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatCoachs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatCoachs_Users_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatCoachs_Users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DietaryRecommendations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DietaryRecommendations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenerationAI = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodPrograms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FoodPrograms_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SportsProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SportsProfiles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatCoachs_ReceiverId",
                table: "ChatCoachs",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatCoachs_SenderId",
                table: "ChatCoachs",
                column: "SenderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DietaryRecommendations_UserId",
                table: "DietaryRecommendations",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SportsProfiles_UserId",
                table: "SportsProfiles",
                column: "UserId");
